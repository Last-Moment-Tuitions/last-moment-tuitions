...
// Premium Button Component
export function Button({ children, variant = 'primary', size = 'md', className, icon, href, ...props }) {
...
// Input Component
export const Input = React.forwardRef(({ className, type, icon, ...props }, ref) => {
    return (
...
export const Label = React.forwardRef(({ className, ...props }, ref) => (
    <label
        ref={ref}
        className={cn(
            "text-sm font-semibold leading-none peer-disabled:cursor-not-allowed peer-disabled:opacity-70 mb-2 block text-gray-700",
            className
        )}
        {...props}
    />
...
export function GoogleButton({ className, ...props }) {
    return (
        <button
            className={cn(
                "flex h-12 w-full items-center justify-center gap-3 rounded-xl border border-gray-200 bg-white px-4 py-2 text-sm font-semibold text-gray-700 shadow-sm transition-all hover:bg-gray-50 hover:text-gray-900 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-gray-400 focus-visible:ring-offset-2 hover:shadow-md",
                className
            )}
            {...props}
        >
